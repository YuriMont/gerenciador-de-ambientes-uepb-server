...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity.csrf(csrf -> csrf.disable()) // Desativar a proteção de sessão de
                                                         // formularios html
                .cors(cors -> cors.configure(httpSecurity)) // Permitir dominios acessem a aplicação
                .sessionManagement(
