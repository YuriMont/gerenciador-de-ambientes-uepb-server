 ...
 *
 * <p>Todos os endpoints requerem autenticação via token JWT. Alguns endpoints
 * possuem restrições adicionais por perfil de acesso:</p>
 * <ul>
...
public class PersonController {
     ...
     *
     * <p>Acesso restrito a usuários com perfil {@code ADMIN} ou {@code OWNER}.</p>
     *
     ...
     *
     * <p>Acesso exclusivo para usuários com perfil {@code OWNER}.</p>
     *
    ...
    @ApiResponses({
        ...
        @ApiResponse(responseCode = "401", description = "Não autenticado", content = @Content),
        @ApiResponse(responseCode = "403", description = "Acesso negado (requer OWNER)", content = @Content),
