 ...
 */
import type { SlotAvailabilityResponse } from "./slotAvailabilityResponse";

/**
 * Agenda resumida de um ambiente em uma data
 */
export interface EnvironmentAvailabilityResponse {
