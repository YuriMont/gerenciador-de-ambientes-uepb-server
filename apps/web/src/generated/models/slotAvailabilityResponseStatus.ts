 ...
 * Situação do slot
 */
export type SlotAvailabilityResponseStatus =
  (typeof SlotAvailabilityResponseStatus)[keyof typeof SlotAvailabilityResponseStatus];

export const SlotAvailabilityResponseStatus = {
  AVAILABLE: "AVAILABLE",
  RESERVED: "RESERVED",
  CLOSED: "CLOSED",
} as const;
