 ...
 */
import type { SlotAvailabilityResponseStatus } from "./slotAvailabilityResponseStatus";

/**
 * Situação de um slot de 1 hora na agenda de um ambiente
 */
export interface SlotAvailabilityResponse {
  ...
  endTime?: string;
  /** Situação do slot */
  status?: SlotAvailabilityResponseStatus;
}
