 ...
 */
import type { ReserveSlot } from "./reserveSlot";

/**
 * Dados para solicitação de reserva de um ambiente
 */
export interface CreateReserveRequest {
  /** Data da reserva (não pode ser no passado) */
  date: string;
  /** ID do ambiente a ser reservado */
  ...
  /** Justificativa para a reserva */
  justification: string;
  /** Lista de slots de horário (mínimo 1) */
  slots: ReserveSlot[];
}
